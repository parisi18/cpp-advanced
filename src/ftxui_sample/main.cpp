...
// configuration step. It creates a namespace called `cpp_advanced`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_advanced::cmake::project_name, cpp_advanced::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_advanced::cmake::project_version);
      return EXIT_SUCCESS;
    }
